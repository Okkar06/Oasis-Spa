...
CREATE TABLE "membership_accounts" (
    ...
    CONSTRAINT "membership_accounts_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "employee_to_position_employee_id_position_id_key" ON "employee_to_position"("employee_id", "position_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "settings_type_key" ON "settings"("type", "key");
...
-- AddForeignKey
ALTER TABLE "user_to_role" ADD CONSTRAINT "user_to_role_user_auth_id_fkey" FOREIGN KEY ("user_auth_id") REFERENCES "user_auth"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "voucher_template_details" ADD CONSTRAINT "voucher_template_details_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "services"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "stored_value_accounts_transaction_logs" ADD CONSTRAINT "stored_value_accounts_transaction_logs_stored_value_accoun_fkey" FOREIGN KEY ("stored_value_account_id") REFERENCES "stored_value_accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
