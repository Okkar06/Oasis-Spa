  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const normalized = response.data.productCategories.map((cat) => ({
          ...cat,
          product_category_name: cat.product_category_name || cat.productCategoryName || cat.productCategory?.productCategoryName || cat.productCategoryName || '',
          ...
          <SidebarInset>
            <div className='flex flex-col p-6 gap-6'>
              ...
              <div className='flex items-center space-x-4'>
                <CreateCategoryInlineForm apiEndpoint='/product/create-product-cat' onCreate={fetchCategories} fieldName='product_category_name' />
                <Button
                 onClick={async () => {
                    if (!showReorderPanel) {
